...
##
# This script builds docker image of the bookmyhike service
# Run this script AFTER compiling the code and building the bookmyhike.jar in target folder
# 
